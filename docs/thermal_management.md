The module can reach temperatures greater than 85&deg;C (185&deg;F) when operating at full read power over extended periods of time so thermal management is an important consideration using this board. 
